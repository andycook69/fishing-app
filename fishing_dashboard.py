...
selected_river = st.sidebar.selectbox("Select Target River Beat:", list(RIVER_DATA.keys()))
...
if os.path.exists("historical_catch_data.csv"):
    ...
    fig = px.bar(filtered_df, x="Year", y="Declared_Catches", 
